...
const APP_DIR = joinpath(BUILD_ROOT, "mm-jl-rag-app")
const LAUNCHER_PATH = joinpath(BUILD_ROOT, "mm-jl-rag")
...
PackageCompiler.create_app(
    PROJECT_DIR,
    APP_DIR;
    executables = ["mm-jl-rag" => "julia_main"],
    force = true,
    incremental = false,
)
...
open(LAUNCHER_PATH, "w") do io
    ...
    println(io, "exec \"\$SCRIPT_DIR/mm-jl-rag-app/bin/mm-jl-rag\" \"\$@\"")
end
